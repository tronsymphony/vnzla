    ...
    <div class="container">
      <div class="tabs-loan__wrapper" data-tabs>
        <div class="tabs-loan__tabs" data-triggers>
          <a class="tabs-loan__tab disabled" href="#línea-paralela">Línea paralela</a>
          <a class="tabs-loan__tab" href="#personales">Personales</a>
          <a class="tabs-loan__tab disabled" href="#comerciales">Comerciales</a>
          <a class="tabs-loan__tab" href="#vivienda">Vivienda</a>
          <a class="tabs-loan__tab disabled" href="#agropecuarios">Agropecuarios</a>
        </div>
        <div class="tabs-loan__body" data-body>
          ...
          <div class="tabs-loan__content" data-id="#personales">
            <h2 class="tabs-loan__title">
              Estoy buscando un crédito comercial de...
            </h2>
          ...
          <div class="tabs-loan__content" data-id="#vivienda">
            <div class="tabs-loan__inner">
              ...
              <?php endif; ?>
              <div class="tabs-loan__line">
                <?php if ($attributes['swicher1']['title']['desktop'] || $attributes['swicher1']['title']['mobile']) : ?>
                  <div class="tabs-loan__item tabs-loan__item--swicher">
                    <h3 class="tabs-loan__item-title">
                      <?php if ($attributes['swicher1']['title']['desktop']) : ?>
                        <span class="<?= ($attributes['swicher1']['title']['mobile']) ? 'only-desktop' : '' ?>"><?= $attributes['swicher1']['title']['desktop'] ?></span>
                      <?php endif; ?>
                      <?php if ($attributes['swicher1']['title']['mobile']) : ?>
                        <span class="only-mobile"><?= $attributes['swicher1']['title']['mobile'] ?></span>
                      <?php endif; ?>
                    </h3>
                    <button class="tabs-loan__currency">
                      <div class="tabs-loan__currency-wrapper">
                        <input type="checkbox" />
                        <div class="tabs-loan__currency-button"></div>
                        <div class="tabs-loan__currency-span-1">1</div>
                        <div class="tabs-loan__currency-span-1-mobile">1</div>
                        <div class="tabs-loan__currency-span-2">2+</div>
                        <div class="tabs-loan__currency-span-2-mobile">2+</div>
                      </div>
                    </button>
                  </div>
                <?php endif; ?>
                <?php if ($attributes['swicher2']['title']['desktop'] || $attributes['swicher2']['title']['mobile']) : ?>
                  <div class="tabs-loan__item tabs-loan__item--swicher2">
                    <h3 class="tabs-loan__item-title">
                      <?php if ($attributes['swicher2']['title']['desktop']) : ?>
                        <span class="<?= ($attributes['swicher2']['title']['mobile']) ? 'only-desktop' : '' ?>"><?= $attributes['swicher2']['title']['desktop'] ?></span>
                      <?php endif; ?>
                      <?php if ($attributes['swicher2']['title']['mobile']) : ?>
                        <span class="only-mobile"><?= $attributes['swicher2']['title']['mobile'] ?></span>
                      <?php endif; ?>
                    </h3>
                    <button class="tabs-loan__currency2">
                      <div class="tabs-loan__currency2-wrapper">
                        <input type="checkbox" />
                        <div class="tabs-loan__currency2-button"></div>
                        <div class="tabs-loan__currency2-span-1">RD</div>
                        <div class="tabs-loan__currency2-span-1-mobile">RD</div>
                        <div class="tabs-loan__currency2-span-2">US</div>
                        <div class="tabs-loan__currency2-span-2-mobile">US</div>
                      </div>
                    </button>
                  </div>
                <?php endif; ?>
                <?php if ($attributes['counter']['title']['desktop'] || $attributes['counter']['title']['mobile']) : ?>
                  <div class="tabs-loan__item tabs-loan__item--counter">
                    ...
                    <div class="tabs-loan__counter counter" data-min="1" data-max="100" data-set="18">
                      <input type="number" hidden>
                      <button class="counter__button counter__button--minus"></button>
                      <div class="counter__content">0</div>
                      <button class="counter__button counter__button--plus"></button>
                ...
                <?php endif; ?>
                <?php if ($attributes['input1']['title']['desktop'] || $attributes['input1']['title']['mobile']) : ?>
                  <div class="tabs-loan__item tabs-loan__item--input">
                    <h3 class="tabs-loan__item-title">
                      <?php if ($attributes['input1']['title']['desktop']) : ?>
                        <span class="<?= ($attributes['input1']['title']['mobile']) ? 'only-desktop' : '' ?>"><?= $attributes['input1']['title']['desktop'] ?></span>
                      <?php endif; ?>
                      <?php if ($attributes['input1']['title']['mobile']) : ?>
                        <span class="only-mobile"><?= $attributes['input1']['title']['mobile'] ?></span>
                      <?php endif; ?>
                    </h3>
                    <div class="tabs-loan__input">
                      <span>RD$</span>
                      <input class="input" type="text" placeholder="0" />
                    </div>
                  </div>
                <?php endif; ?>
                <?php if ($attributes['input2']['title']['desktop'] || $attributes['input2']['title']['mobile']) : ?>
                  <div class="tabs-loan__item tabs-loan__item--input">
                    <h3 class="tabs-loan__item-title">
                      <?php if ($attributes['input2']['title']['desktop']) : ?>
                        <span class="<?= ($attributes['input2']['title']['mobile']) ? 'only-desktop' : '' ?>"><?= $attributes['input2']['title']['desktop'] ?></span>
                      <?php endif; ?>
                      <?php if ($attributes['input2']['title']['mobile']) : ?>
                        <span class="only-mobile"><?= $attributes['input2']['title']['mobile'] ?></span>
                      <?php endif; ?>
                    </h3>
                    <div class="tabs-loan__input">
                      <span>RD$</span>
              ...
              <div class="tabs-loan__line">
                <?php if ($attributes['slider1']['title']['desktop'] || $attributes['slider1']['title']['mobile']) : ?>
                  <div class="tabs-loan__item tabs-loan__item--slider">
                    <h3 class="tabs-loan__item-title">
                      <?php if ($attributes['slider1']['title']['desktop']) : ?>
                        <span class="<?= ($attributes['slider1']['title']['mobile']) ? 'only-desktop' : '' ?>"><?= $attributes['slider1']['title']['desktop'] ?></span>
                      <?php endif; ?>
                      <?php if ($attributes['slider1']['title']['mobile']) : ?>
                        <span class="only-mobile"><?= $attributes['slider1']['title']['mobile'] ?></span>
                      <?php endif; ?>
                    </h3>
                    <div class="tabs-loan__slider rd-slider" data-min="0" data-max="150000" data-set="50000" data-step="1000" data-set="50000">
                      <button class="rd-slider__button rd-slider__button--min">min</button>
                      <div class="rd-slider__content"></div>
                      <button class="rd-slider__button rd-slider__button--max">max</button>
                    </div>
                ...
                <?php endif; ?>
                <?php if ($attributes['slider2']['title']['desktop'] || $attributes['slider2']['title']['mobile']) : ?>
                  <div class="tabs-loan__item tabs-loan__item--slider">
                    <h3 class="tabs-loan__item-title">
                ...
                <?php endif; ?>
                <?php if ($attributes['counter2']['title']['desktop'] || $attributes['counter2']['title']['mobile']) : ?>
                  <div class="tabs-loan__item tabs-loan__item--counter2">
                    <h3 class="tabs-loan__item-title">
                    ...
                    <div class="tabs-loan__counter2 counter" data-min="1" data-max="100" data-set="1">
                      <input type="number" hidden>
                      <button class="counter__button counter__button--minus"></button>
                      <div class="counter__content">0</div>
                      <button class="counter__button counter__button--plus"></button>
                ...
                <?php if ($attributes['button']['title']['desktop'] || $attributes['button']['title']['mobile']) : ?>
                  <div class="tabs-loan__item tabs-loan__item--button">
                    <div class="tabs-loan__buttons">
                      <button class="tabs-loan__button primary-button button1">
              ...
              <div class="tabs-loan__hidden">
                <div class="tabs-loan__block">
                  <div class="tabs-loan__block-first">
                    <span>La mensualidad a pagar será de:</span>
                    <span>RD$ 3,747.91 | Tasa anual: 20%</span>
                  </div>
                  <div class="tabs-loan__block-body">
                    <ul>
                      <li><span>Cuota mensual</span><span>RD$ 3,705.38</span></li>
                      <li><span>Seguro de vida </span><span>RD$ 23.2</span></li>
                      <li><span>Seguro de propiedad </span><span>RD$ 19.33</span></li>
                    </ul>
                  </div>
                  <div class="tabs-loan__block-footer">
                    <div class="tabs-loan__block-button">No califica, la cuota a pagar excede el 30% de los ingresos
                    </div>
                  </div>
                </div>
                <div class="tabs-loan__info">
                  El presente simulador de préstamos es una herramienta orientativa que proporciona un resultado según información proporcionada por el interesado que no fue constatada formalmente por Banesco, sin haber realizado la respectiva evaluación de crédito, por lo que no constituye una oferta, obligación o compromiso alguno por parte del Banco para su otorgamiento.
                </div>
              </div>
            </div>
          </div>
  ...
  new class Tabs {
    ...
    init() {
      document.querySelectorAll('[data-tabs]').forEach((wrapper) => {
        ...
        this.$triggers[3].classList.add('active');
        this.$body[3].classList.add('active');
        this.update();
