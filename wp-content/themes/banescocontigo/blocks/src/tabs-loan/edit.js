				...
				<div className="settings">
					...
					<div className="row">
						<TextControl
							...
							className="input"
							onChange={(value) => {
								const newLink = { ...swicher1 }
								newLink.title.desktop = value
								setAttributes({ swicher1: newLink })
							}}
						/>
						<TextControl
							label="Mobile (optional)"
					...
					<div className="row">
						<TextControl
							...
							className="input"
							onChange={(value) => {
								const newLink = { ...swicher2 }
								newLink.title.desktop = value
								setAttributes({ swicher2: newLink })
							}}
						/>
						<TextControl
							label="Mobile (optional)"
					...
					<div className="row">
						<TextControl
							...
							className="input"
							onChange={(value) => {
								const newLink = { ...input1 }
								newLink.title.desktop = value
								setAttributes({ input1: newLink })
							}}
						/>
						<TextControl
							label="Mobile (optional)"
					...
					<div className="row">
						<TextControl
							...
							className="input"
							onChange={(value) => {
								const newLink = { ...input2 }
								newLink.title.desktop = value
								setAttributes({ input2: newLink })
							}}
						/>
						<TextControl
							label="Mobile (optional)"
					...
					<div className="row">
						<TextControl
							...
							className="input"
							onChange={(value) => {
								const newLink = { ...slider1 }
								newLink.title.desktop = value
								setAttributes({ slider1: newLink })
							}}
						/>
						<TextControl
							label="Mobile (optional)"
