      ...
      <div class="hero-video__inner">
        <div class="hero-video__content">
          ...
          <?php if ($attributes['description']['desktop'] || $attributes['description']['mobile']) : ?>
            <div class="hero-video__description text">
          ...
          <?php if ($attributes['button']['desktop'] || $attributes['button']['mobile']) : ?>
            <div class="hero-video__buttons">
              <a class="hero-video__button <?= $attributes['button']['type'] ?>" href="<?= $attributes['button']['target'] ?>">
        ...
        <?php if ($attributes['image']['desktop']['url'] || $attributes['image']['mobile']['url']) : ?>
          <div class="hero-video__play">
            <a class="hero-video__play-link" href="<?= $attributes['image']['target'] ?>">
              <?php if ($attributes['image']['desktop']['url']) : ?>
                <?php if ($attributes['image']['desktop']['url'] == 'play.svg') : ?>
                  <img class="<?= ($attributes['image']['mobile']['url']) ? 'only-desktop' : '' ?>" src="<?php the_block_url(__DIR__); ?>/assets/play.svg" alt="image" />
              ...
              <?php if ($attributes['image']['mobile']['url']) : ?>
                <?php if ($attributes['image']['mobile']['url'] == 'play.svg') : ?>
                  <img class="only-mobile" src="<?php the_block_url(__DIR__); ?>/assets/play.svg" alt="image" />
