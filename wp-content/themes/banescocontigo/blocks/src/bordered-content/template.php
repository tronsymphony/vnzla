 ...
 * @param string   $bordered-content        Rendered block output. ie. <InnerBlocks.bordered-content />.
...
<section <?php echo wp_kses_data(get_block_wrapper_attributes()); ?>>
  <div class="bordered-content" style="
    ...
    ">
    <div class="container">
      <div class="bordered-content__inner">
        <?php if ($attributes['title']['desktop'] || $attributes['title']['mobile']) : ?>
          <h2 class="bordered-content__title">
        ...
        <?php if ($attributes['content']['desktop'] || $attributes['content']['mobile']) : ?>
          <div class="bordered-content__content text">
