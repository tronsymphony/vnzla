...
<section <?php echo wp_kses_data(get_block_wrapper_attributes()); ?>>
  <div class="hero-promotion" style="
      ...
      --margins-categories: <?= ($attributes['margins']['desktop']['categories']) ? $attributes['margins']['desktop']['categories'] : '0px' ?>;
      --margins-categories--mobile: <?= ($attributes['margins']['mobile']['categories']) ? $attributes['margins']['mobile']['categories'] : '0px' ?>;
      ...
      --colors-categories: <?= ($attributes['colors']['categories']) ? $attributes['colors']['categories'] : '#fff' ?>;
    ...
    ">
    <div class="container">
      <div class="hero-promotion__inner">
        <div class="hero-promotion__content">
          <?php if ($attributes['title']['desktop'] || $attributes['title']['mobile']) : ?>
            <h2 class="hero-promotion__title">
          ...
          <?php if ($attributes['description']['desktop'] || $attributes['description']['mobile']) : ?>
            <h3 class="hero-promotion__description">
          ...
          <?php if ($post_categories) : ?>
            <div class="hero-promotion__categories">
              <?php foreach ($post_categories as $category) :  ?>
                <a href="/promociones?category=<?php echo $category->slug; ?>" class="hero-promotion__category"><?php echo $category->name; ?></a>
              <?php endforeach; ?>
            </div>
          <?php endif; ?>
        </div>
