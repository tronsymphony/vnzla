...
namespace Smartling\Vendor\Symfony\Component\Config\Tests\Loader;

use PHPUnit\Framework\TestCase;
use Smartling\Vendor\Symfony\Component\Config\Loader\FileLoader;
use Smartling\Vendor\Symfony\Component\Config\Loader\LoaderResolver;

class FileLoaderTest extends TestCase
{
    public function testImportWithFileLocatorDelegation()
    {
        $locatorMock = $this->getMockBuilder('Smartling\Vendor\Symfony\Component\Config\FileLocatorInterface')->getMock();

        $locatorMockForAdditionalLoader = $this->getMockBuilder('Smartling\Vendor\Symfony\Component\Config\FileLocatorInterface')->getMock();
        ...
        try {
            ...
            $this->assertInstanceOf('Smartling\Vendor\Symfony\Component\Config\Exception\FileLoaderImportCircularReferenceException', $e, '->import() throws a FileLoaderImportCircularReferenceException if the resource is already loading');
        }
