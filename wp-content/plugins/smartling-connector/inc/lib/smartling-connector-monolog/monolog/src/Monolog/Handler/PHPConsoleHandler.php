 ...
 *
 *      $logger = new \Smartling\Vendor\Monolog\Logger('all', array(new \Smartling\Vendor\Monolog\Handler\PHPConsoleHandler()));
 * \Smartling\Vendor\Monolog\ErrorHandler::register($logger);
 *      echo $undefinedVar;
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    private $options = array(
        ...
        'classesPartialsTraceIgnore' => array('Smartling\Vendor\Smartling\\Vendor\\Smartling\\Vendor\\Monolog\\'), // array Hide calls of classes started with...
    ...
    /**
     * @param  array          $options   See \Smartling\Vendor\Monolog\Handler\PHPConsoleHandler::$options for more details
