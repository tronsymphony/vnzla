...
namespace Smartling\Vendor\Smartling\Tests;
use Smartling\Vendor\Smartling\Context\ContextApi;
use Smartling\Vendor\Smartling\Context\Params\MatchContextParameters;
use Smartling\Vendor\Smartling\Context\Params\MissingResourcesParameters;
use Smartling\Vendor\Smartling\Context\Params\UploadContextParameters;
use Smartling\Vendor\Smartling\Tests\Unit\ApiTestAbstract;
use Smartling\Vendor\Smartling\Context\Params\UploadResourceParameters;


/**
 * Test class for Smartling\Vendor\Smartling\Context\ContextApi.
 */
class ContextApiTest extends ApiTestAbstract
{
    ...
    {
        $this->object = $this->getMockBuilder('Smartling\Vendor\Smartling\Context\ContextApi')
            ->setMethods(['readFile'])
            ->setConstructorArgs([
                $this->projectId,
                $this->client,
    ...
    /**
     * @covers \Smartling\Vendor\Smartling\Context\ContextApi::uploadContext
     */
    ...
    /**
     * @covers \Smartling\Vendor\Smartling\Context\ContextApi::uploadAndMatchContext
     */
    ...
    /**
     * @covers \Smartling\Vendor\Smartling\Context\ContextApi::getMissingResources
     */
    ...
    /**
     * @covers \Smartling\Vendor\Smartling\Context\ContextApi::uploadResource
     */
    ...
    /**
     * @covers \Smartling\Vendor\Smartling\Context\ContextApi::renderContext
     */
