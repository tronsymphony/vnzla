...
/**
 * Test class for Smartling\Vendor\Smartling\Project\ProjectsApi.
 */
class ProjectApiTest extends ApiTestAbstract
{
    /**
     * @covers \Smartling\Vendor\Smartling\Project\ProjectApi::getProjectDetails
     */
    ...
    {
        $this->object = $this->getMockBuilder('Smartling\Vendor\Smartling\Project\ProjectApi')
            ->setMethods(NULL)
            ->setConstructorArgs([
                $this->projectId,
                $this->client,
