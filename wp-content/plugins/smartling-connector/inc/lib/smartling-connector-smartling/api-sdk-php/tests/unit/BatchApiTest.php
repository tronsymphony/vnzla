...
/**
 * Test class for Smartling\Vendor\Smartling\Batch\BatchApi.
 */
class BatchApiTest extends ApiTestAbstract
{
    ...
    private function prepareBatchApiMock() {
        $this->object = $this->getMockBuilder('Smartling\Vendor\Smartling\Batch\BatchApi')
            ->setMethods(['readFile'])
            ->setConstructorArgs([
                $this->projectId,
                $this->client,
    ...
    /**
     * @covers \Smartling\Vendor\Smartling\Batch\BatchApi::createBatch
     */
    ...
    /**
     * @covers \Smartling\Vendor\Smartling\Batch\BatchApi::uploadBatchFile
    ...
    /**
     * @covers \Smartling\Vendor\Smartling\Batch\BatchApi::executeBatch
     */
    ...
    /**
     * @covers \Smartling\Vendor\Smartling\Batch\BatchApi::getBatchStatus
     */
    ...
    /**
     * @covers \Smartling\Vendor\Smartling\Batch\BatchApi::listBatches
     */
