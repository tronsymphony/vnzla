 ...
 * @package Smartling\Vendor\Smartling\Tests
 */
abstract class ApiTestAbstract extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->client = $this->getMockBuilder('Smartling\Vendor\GuzzleHttp\Client')
            ->setMethods(
                array_merge(
    ...
    {
        $this->authProvider = $this->getMockBuilder('\Smartling\Vendor\Smartling\AuthApi\AuthApiInterface')
            ->setMethods(
                [
                    'getAccessToken',
                    'getTokenType',
