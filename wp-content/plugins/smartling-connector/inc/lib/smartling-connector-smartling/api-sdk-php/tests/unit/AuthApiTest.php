...
/**
 * Test class for Smartling\Vendor\Smartling\AuthApi\AuthTokenProvider.
 */
class AuthApiTest extends ApiTestAbstract
{
    ...
    {
        $this->object = $this->getMockBuilder('Smartling\Vendor\Smartling\AuthApi\AuthTokenProvider')
            ->setMethods(NULL)
            ->setConstructorArgs([
                $this->userIdentifier,
                $this->secretKey,
    ...
    public function testAuthenticateWithInvalidCredentials() {
        $response_mock = $this->getMockBuilder('Smartling\Vendor\GuzzleHttp\Psr7\Response')
            ->setMethods(
                array_merge(
        ...
        $client_mock = $this->getMockBuilder('Smartling\Vendor\GuzzleHttp\Client')
            ->setMethods(
                array_merge(
        ...
        $auth_api_mock = $this->getMockBuilder('Smartling\Vendor\Smartling\AuthApi\AuthTokenProvider')
            ->setMethods(NULL)
            ->setConstructorArgs([
                $this->userIdentifier,
                $this->secretKey,
