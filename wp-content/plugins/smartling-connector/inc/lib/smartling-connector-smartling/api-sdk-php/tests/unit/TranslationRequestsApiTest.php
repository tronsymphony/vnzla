...
use Smartling\Vendor\Smartling\TranslationRequests\TranslationRequestsApi;
...
class TranslationRequestsApiTest extends ApiTestAbstract
{
    ...
    {
        $this->object = $this->getMockBuilder('Smartling\Vendor\Smartling\TranslationRequests\TranslationRequestsApi')
            ->setMethods(null)
            ->setConstructorArgs([
                $this->projectId,
                $this->client,
    ...
    {
        $this->responseMock = $this->getMockBuilder('Smartling\Vendor\GuzzleHttp\Psr7\Response')
            ->setMethods(
                array_merge(
    ...
    /**
     * @covers \Smartling\Vendor\Smartling\TranslationRequests\TranslationRequestsApi::createTranslationRequest
     */
    ...
    /**
     * @covers \Smartling\Vendor\Smartling\TranslationRequests\TranslationRequestsApi::updateTranslationRequest
     */
    ...
    /**
     * @covers \Smartling\Vendor\Smartling\TranslationRequests\TranslationRequestsApi::getTranslationRequest
     */
    ...
    /**
     * @covers \Smartling\Vendor\Smartling\TranslationRequests\TranslationRequestsApi::searchTranslationRequests
     * @dataProvider searchTranslationRequestTestDataProvider
     * @param SearchTranslationRequestParams $searchParams
     * @param array $queryParams
     * @param array $rawResponse
     * @throws \Smartling\Vendor\Smartling\Exceptions\InvalidAccessTokenException
     */
