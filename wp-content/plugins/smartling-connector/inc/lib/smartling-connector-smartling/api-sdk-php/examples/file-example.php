...
try {
    ...
    $fileApi = \Smartling\Vendor\Smartling\File\FileApi::create($authProvider, $projectId);
...
try {
    ...
    $params = new \Smartling\Vendor\Smartling\File\Params\DownloadFileParameters();
...
try {
    ...
    $params = new \Smartling\Vendor\Smartling\File\Params\ListFilesParameters();
    $params
