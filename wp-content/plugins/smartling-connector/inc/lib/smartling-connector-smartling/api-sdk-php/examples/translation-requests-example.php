...
function createTranslationRequestDemo($authProvider, $projectId, $demoBucketName, $demoCreateParams)
{
    ...
    $response = [];
    $translationRequestsApi = \Smartling\Vendor\Smartling\TranslationRequests\TranslationRequestsApi::create($authProvider, $projectId);
...
$demoCreateParams = (new \Smartling\Vendor\Smartling\TranslationRequests\Params\CreateTranslationRequestParams())
...
$demoUpdateParams = (new \Smartling\Vendor\Smartling\TranslationRequests\Params\UpdateTranslationRequestParams())
...
$searchParams = (new \Smartling\Vendor\Smartling\TranslationRequests\Params\SearchTranslationRequestParams())
    ->setFileUri('%' . $time . '%');
