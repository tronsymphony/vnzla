...
{
    $response = false;
    $progressTracker = \Smartling\Vendor\Smartling\ProgressTracker\ProgressTrackerApi::create($authProvider, $projectId);
    $st = microtime(true);
...
function createRecordDemo($authProvider, $projectId, $spaceId, $objectId)
{
    ...
    $params = new \Smartling\Vendor\Smartling\ProgressTracker\Params\RecordParameters();
    $params->setTtl(15);
    $params->setData([
      "foo" => "bar"
    ]);
