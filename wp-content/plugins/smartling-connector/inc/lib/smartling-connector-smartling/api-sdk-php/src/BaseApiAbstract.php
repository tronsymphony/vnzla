...
namespace Smartling\Vendor\Smartling;
...
use Smartling\Vendor\GuzzleHttp;
...
use Smartling\Vendor\Smartling\Logger\DevNullLogger;

/**
 * Class BaseApiAbstract
 *
 * @package Smartling\Vendor\Smartling\Api
 */
abstract class BaseApiAbstract
{
    ...
    const CLIENT_LIB_ID_VERSION = '3.6.4';
                ...
                'headers' => [
                    'User-Agent' => vsprintf(
                        ...
                        [
                            ...
                            self::getCurrentClientUserAgentExtension(), \Smartling\Vendor\GuzzleHttp\default_user_agent()
                        ]
                    ),
                ],
            ]
