...
namespace Smartling\Vendor\Smartling\Context;
...
use Smartling\Vendor\Smartling\Wait;
use Smartling\Vendor\Smartling\Waitable;
...
class ContextApi extends BaseApiAbstract implements Waitable
{
     ...
     *
     * @param \Smartling\Vendor\Smartling\Context\Params\UploadContextParameters $params
     * @return array
     * @throws \Smartling\Vendor\Smartling\Exceptions\SmartlingApiException
     */
     ...
     *
     * @param $contextUid
     * @param \Smartling\Vendor\Smartling\Context\Params\MatchContextParameters $params
     *
     * @return array
     * @throws \Smartling\Vendor\Smartling\Exceptions\SmartlingApiException
     */
     ...
     *
     * @param $resourceId
     * @param \Smartling\Vendor\Smartling\Context\Params\UploadResourceParameters $params
     * @return bool
     * @throws SmartlingApiException
     */
